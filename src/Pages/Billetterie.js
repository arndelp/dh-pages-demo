    ...
    function BilletD() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <p className="btn btn-danger bout">Complet</p>
          </div>
        </div>
      ...
      function BilletS() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <p className="card-text">Valable le 10/07/2027 </p>
            <p  className="btn btn-danger">Complet</p>
          </div>
        </div>
      ...
      function BilletV() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <p  className="btn btn-primary bout">Acheter</p>
          </div>
        </div>
      ...
      function Pass2joursSD() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <p  className="btn btn-primary">Acheter</p>
          </div>
        </div>
