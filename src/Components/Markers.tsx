    ...
    <>
      {props.pois.map( (Val: Poi) => (
        <AdvancedMarker
          ...
          <img src={Val.image} width={Val.width} height={Val.height} alt={Val.name} />                 
        </AdvancedMarker>
      ))}
    </>
  );
    ...
    <div className="legend">
     <div className="ico">
      ...
      <div className="ico">
          ...
          <img src="../assets/toilettes.png" width="25em" height= "25em" alt="toilet"/>
      </div>  
    </div> 
    </>
  );
